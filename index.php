...
$output = array();
if ($xlsx = SimpleXLSX::parse('yazio_101.xlsx')) {
		$i = 0;

    foreach ($xlsx->rows() as $elt) {
    	$tmp = array();
    	//['Product', 'Valeur_calorique','Proteine','Lipides','Glucides','Sodium','Potassium','Magnesium','Calcium']
      if ($i == 0) {
      	// array_push($tmp, $elt[1], $elt[2], $elt[10], $elt[4], $elt[8], $elt[13], $elt[33], $elt[30], $elt[27]);
      	// print_r($tmp);
      } else {
      	array_push($tmp, $elt[1], $elt[2], $elt[10], $elt[4], $elt[8], $elt[13], $elt[33], $elt[30], $elt[27]);
      }      
